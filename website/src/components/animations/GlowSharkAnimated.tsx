...
function computeWave({ basePositions, time, wavelength, speed }: WaveProps) {
...
function computeSegments(basePositions: Float32Array<ArrayBuffer>, numSegments: number) {
    let minY = Infinity,
        maxY = -Infinity;
