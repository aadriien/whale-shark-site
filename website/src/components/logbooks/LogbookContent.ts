...
export const pageContent: PageContent = {
    home: {
        overview:
            "This is your entry point into the whale shark site. Interact with the particle blobs and start exploring!",
        faqs: [
            {
    ...
    about: {
        overview:
            "This is an overview of whale sharks! Learn what they are and why they are important.",
        faqs: [
            {
    ...
    research: {
        overview:
            "This is your entry point into the research side of the site. Dive into the data and see real whale sharks!",
        faqs: [
            {
    ...
    creative: {
        overview:
            "This is your entry point into the creative side of the site. Play with the interactives and have fun!",
        faqs: [
            {
    ...
    globeviews: {
        overview:
            "This is a view of whale shark sightings around the world! Move the globe and toy with filters to get started.",
        faqs: [
            {
    ...
    sharktracker: {
        overview:
            "This is a storytelling experience where you can see the real movements over time of specific whale sharks!",
        faqs: [
            {
    ...
    geolabs: {
        overview:
            "This is an interactive page that allows you to explore your favorite whale sharks in greater depth.",
        faqs: [
            {
    ...
    environment: {
        overview:
            "This is a glimpse into ocean conditions over time, powered by Copernicus Marine.",
        faqs: [
            {
    ...
    sharkvision: {
        overview:
            "This is a technological overview of computer vision, a field of AI. Learn how it can help us study whale sharks!",
        faqs: [
            {
    ...
    animation: {
        overview:
            "This is a sandbox for creating your own custom swimming path for a 3D model of a whale shark.",
        faqs: [
            {
