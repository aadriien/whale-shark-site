...
GBIF_STORY_SHARK_TRACKING_JSON = (
    "website/src/assets/data/json/gbif_story_shark_tracking.json"
)

# GeoJSON files for Copernicus Marine data layer integration
GBIF_SHARK_TRACKING_MULTI_GEOJSON = (
    "website/src/assets/data/json/gbif_shark_tracking_multipoint_geojson.json"
)
GBIF_SHARK_TRACKING_LINE_GEOJSON = (
    "website/src/assets/data/json/gbif_shark_tracking_linestring_geojson.json"
)
...
GBIF_MEDIA_SHARK_TRACKING_JSON = (
    "website/src/assets/data/json/gbif_media_shark_tracking.json"
)
